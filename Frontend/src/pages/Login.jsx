...
const Login = () => {
  ...
  return (
    <form
      ...
      className="flex flex-col items-center justify-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800  "
    >
      ...
      <button
        type="submit"
        className="bg-tertiary text-white font-medium mt-4 px-8 py-2 rounded"
      >
        {loading
          ? "Processing..."
          : currentState === "Login"
