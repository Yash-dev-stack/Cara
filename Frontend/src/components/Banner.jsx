...
const Banner = () => {
  return (
    <div className=" mt-[21px] sm:mt-[40px] mb-[21px] sm:mb-[40px] flex items-center justify-center bg-banner w-full h-[27vh] sm:h-[40vh] p-[15px] bg-cover bg-center flex-col">
